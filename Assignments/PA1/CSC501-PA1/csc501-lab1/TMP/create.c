...
/*Modifications made --> added two arguments for each created process, goodness and quantum*/    
#include <conf.h>
#include <i386.h>
#include <kernel.h>
#include <proc.h>
					...
					/* array in the code)		*/
{
	...
	pptr->quantum=0;
	/*
 *Variabble for considering the quantum and goodness of priority for linux based schedulers
 * */
		/* Bottom of stack */
	*saddr = MAGIC;
